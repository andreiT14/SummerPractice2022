...
module m_alu(A, B, ALU_sel, ALU_out, Flag);
  ...
  output [3:0] Flag; // Flag[0] - ZeroFlag (ZF), Flag[1] - CarryFlag (CF), Flag[2] - OverflowFlag (OF), Flag[3] - UnderflowFlag (UF)
    
	reg [7:0] ALU_Result;
	wire [8:0] tmp;
    assign ALU_Out = ALU_Result; // ALU out
    assign tmp = {1'b0,A} + {1'b0,B};
  	assign Flag[1] = tmp[8]; // Carry flag
